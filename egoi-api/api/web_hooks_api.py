...
class WebHooksApi(object):
    ...
    def create_webhook(self, webhook, **kwargs):  # noqa: E501
        ...
        :param Webhook webhook: Parameters for the webhook (required)
    ...
    def create_webhook_with_http_info(self, webhook, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('webhook' not in local_var_params or  # noqa: E501
                                                        local_var_params['webhook'] is None):  # noqa: E501
    ...
    def delete_webhook(self, webhook_id, **kwargs):  # noqa: E501
        ...
        Remove webhook information given its ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def delete_webhook_with_http_info(self, webhook_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'webhook_id' in local_var_params and local_var_params['webhook_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `webhook_id` when calling `delete_webhook`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_all_webhooks(self, **kwargs):  # noqa: E501
        ...
        Returns all webhooks  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_all_webhooks_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ListCollection1, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `get_all_webhooks`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_all_webhooks`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_all_webhooks`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ListCollection1',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),

...
class ProductPatchRequest(object):
    ...
    def __init__(self, name=None, description=None, sku=None, upc=None, ean=None, gtin=None, mpn=None, link=None, image_link=None, price=None, sale_price=None, brand=None, categories=None, related_products=None, local_vars_configuration=None):  # noqa: E501

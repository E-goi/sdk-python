...
# body param
SchemaForRequestBodyApplicationJson = RemoveRequest


request_body_remove_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RemoveResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _action_unsubscribe_contact_oapg(
        self,
    ...
    def _action_unsubscribe_contact_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_remove_request.serialize(body, content_type)
...
class ActionUnsubscribeContact(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def action_unsubscribe_contact(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def action_unsubscribe_contact(
        ...
        return self._action_unsubscribe_contact_oapg(
            body=body,

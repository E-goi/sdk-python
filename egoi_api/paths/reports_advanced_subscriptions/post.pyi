...
# body param
SchemaForRequestBodyApplicationJson = GenerateSubscriptionsReport


request_body_generate_subscriptions_report = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _generate_subscriptions_report_oapg(
        self,
    ...
    def _generate_subscriptions_report_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_generate_subscriptions_report.serialize(body, content_type)
...
class GenerateSubscriptionsReport(BaseApi):
    ...
    def generate_subscriptions_report(
        ...
        return self._generate_subscriptions_report_oapg(
            body=body,

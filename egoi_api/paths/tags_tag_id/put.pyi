...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'tag_id': typing.Union[TagIdSchema, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = TagRequest


request_body_tag_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_tag_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_request.serialize(body, content_type)

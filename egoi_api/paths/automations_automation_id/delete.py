...
# Path params
AutomationIdSchema = QueryId
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'automation_id': typing.Union[AutomationIdSchema, ],
    }
)
...
request_path_automation_id = api_client.PathParameter(
    name="automation_id",
...
class DeleteAutomation(BaseApi):
    ...
    def delete_automation(
        ...
        return self._delete_automation_oapg(

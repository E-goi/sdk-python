...
# body param
SchemaForRequestBodyApplicationJson = ProductPatchRequest


request_body_product_patch_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_product_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_product_patch_request.serialize(body, content_type)

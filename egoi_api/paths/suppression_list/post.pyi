...
# body param
SchemaForRequestBodyApplicationJson = CreateSuppressionListRequest


request_body_create_suppression_list_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_suppression_list_oapg(
        self,
    ...
    def _create_suppression_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_suppression_list_request.serialize(body, content_type)
...
class CreateSuppressionList(BaseApi):
    ...
    def create_suppression_list(
        ...
        return self._create_suppression_list_oapg(
            body=body,

...
class TypeSchema(
    ...
    def EMAIL_DOMAIN(cls):
        return cls("email_domain")
    
    @schemas.classproperty
    def EMAIL_USER(cls):
        return cls("email_user")
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SuppressionList']:
                        return SuppressionList
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SuppressionList'], typing.List['SuppressionList']],
                ...
                def __getitem__(self, i: int) -> 'SuppressionList':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_suppression_list_oapg(
        self,
...
class GetAllSuppressionList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_all_suppression_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_all_suppression_list(
        ...
        return self._get_all_suppression_list_oapg(

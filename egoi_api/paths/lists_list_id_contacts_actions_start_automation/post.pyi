...
# body param
SchemaForRequestBodyApplicationJson = StartAutomationRequest


request_body_start_automation_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = StartAutomationResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _action_start_automation_oapg(
        self,
    ...
    def _action_start_automation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_start_automation_request.serialize(body, content_type)
...
class ActionStartAutomation(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def action_start_automation(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def action_start_automation(
        ...
        return self._action_start_automation_oapg(
            body=body,

...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'field_id': typing.Union[FieldIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PatchRequestBaseField


request_body_patch_request_base_field = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_base_field_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_request_base_field.serialize(body, content_type)
...
class PatchBaseField(BaseApi):
    ...
    def patch_base_field(
        ...
        return self._patch_base_field_oapg(
            body=body,

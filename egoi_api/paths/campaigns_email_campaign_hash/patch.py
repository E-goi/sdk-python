...
# body param
SchemaForRequestBodyApplicationJson = EmailCampaignPatch


request_body_email_campaign_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_email_campaign_oapg(
        self,
    ...
    def _patch_email_campaign_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_email_campaign_patch.serialize(body, content_type)
...
class PatchEmailCampaign(BaseApi):
    ...
    def patch_email_campaign(
        ...
        return self._patch_email_campaign_oapg(
            body=body,

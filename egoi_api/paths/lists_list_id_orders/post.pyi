...
# body param
SchemaForRequestBodyApplicationJson = ImportOrdersBulk


request_body_import_orders_bulk = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _import_orders_bulk_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_import_orders_bulk.serialize(body, content_type)
...
class ImportOrdersBulk(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def import_orders_bulk(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def import_orders_bulk(
        ...
        return self._import_orders_bulk_oapg(
            body=body,

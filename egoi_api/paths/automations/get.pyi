...
# Query params
AutomationIdSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'automation_id': typing.Union[AutomationIdSchema, decimal.Decimal, int, ],
...
request_query_automation_id = api_client.QueryParameter(
    name="automation_id",
    style=api_client.ParameterStyle.FORM,
    schema=AutomationIdSchema,
    explode=True,
)
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Automation']:
                        return Automation
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Automation'], typing.List['Automation']],
                ...
                def __getitem__(self, i: int) -> 'Automation':
...
class GetAllAutomations(BaseApi):
    ...
    def get_all_automations(
        ...
        return self._get_all_automations_oapg(

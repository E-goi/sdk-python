...
# body param
SchemaForRequestBodyApplicationJson = PhoneSenderPost


request_body_phone_sender_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = PhoneSender
...
class BaseApi(api_client.Api):
    ...
    def _create_phone_sender_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_phone_sender_post.serialize(body, content_type)
...
class CreatePhoneSender(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_phone_sender(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_phone_sender(
        ...
        return self._create_phone_sender_oapg(
            body=body,

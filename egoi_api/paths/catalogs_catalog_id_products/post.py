...
# body param
SchemaForRequestBodyApplicationJson = ProductPostRequest


request_body_product_post_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Product
...
SchemaFor409ResponseBodyApplicationJson = PostProductsConflict
...
class BaseApi(api_client.Api):
    ...
    def _create_product_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_product_post_request.serialize(body, content_type)
...
class CreateProduct(BaseApi):
    ...
    def create_product(
        ...
        return self._create_product_oapg(
            body=body,

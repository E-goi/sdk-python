...
# body param
SchemaForRequestBodyApplicationJson = SmsCampaignPatchRequest


request_body_sms_campaign_patch_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_sms_campaign_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sms_campaign_patch_request.serialize(body, content_type)
...
class PatchSmsCampaign(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_sms_campaign(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def patch_sms_campaign(
        ...
        return self._patch_sms_campaign_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = CellphoneSenderPost


request_body_cellphone_sender_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CellphoneSender
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_cellphone_sender_oapg(
        self,
    ...
    def _create_cellphone_sender_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cellphone_sender_post.serialize(body, content_type)
...
class CreateCellphoneSender(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_cellphone_sender(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_cellphone_sender(
        ...
        return self._create_cellphone_sender_oapg(
            body=body,

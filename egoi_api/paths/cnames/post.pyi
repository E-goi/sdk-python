...
# body param
SchemaForRequestBodyApplicationJson = CNamePost


request_body_c_name_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CName
...
SchemaFor409ResponseBodyApplicationJson = PostCNameConflict
...
class BaseApi(api_client.Api):
    ...
    def _create_c_name_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_c_name_post.serialize(body, content_type)
...
class CreateCName(BaseApi):
    ...
    def create_c_name(
        ...
        return self._create_c_name_oapg(
            body=body,

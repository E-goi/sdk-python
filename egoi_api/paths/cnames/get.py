        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CName']:
                        return CName
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CName'], typing.List['CName']],
                ...
                def __getitem__(self, i: int) -> 'CName':
...
class GetAllCNames(BaseApi):
    ...
    def get_all_c_names(
        ...
        return self._get_all_c_names_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = ConnectedSitesDomain


request_body_connected_sites_domain = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ConnectedSitesDomainDetail
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_connected_sites_oapg(
        self,
    ...
    def _create_connected_sites_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_connected_sites_domain.serialize(body, content_type)
...
class CreateConnectedSites(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_connected_sites(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_connected_sites(
        ...
        return self._create_connected_sites_oapg(
            body=body,

...
SchemaFor409ResponseBodyApplicationJson = EnableTransactionalConflict
...
class BaseApi(api_client.Api):
    @typing.overload
    def _enable_transactional_oapg(
        self,
...
class EnableTransactional(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def enable_transactional(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def enable_transactional(
        ...
        return self._enable_transactional_oapg(

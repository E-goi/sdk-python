...
class TypeSchema(
    ...
    class MetaOapg:
        enum_value_to_name = {
            ...
            "unify": "UNIFY",
            "import_ecommerce": "IMPORT_ECOMMERCE",
    ...
    @schemas.classproperty
    def IMPORT_ECOMMERCE(cls):
        return cls("import_ecommerce")
...
class GetAllOperations(BaseApi):
    ...
    def get_all_operations(
        ...
        return self._get_all_operations_oapg(

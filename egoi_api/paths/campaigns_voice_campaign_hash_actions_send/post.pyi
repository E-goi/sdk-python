...
# body param
SchemaForRequestBodyApplicationJson = CampaignVoiceSendRequest


request_body_campaign_voice_send_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AcceptedResponse
...
class BaseApi(api_client.Api):
    ...
    def _action_send_voice_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_voice_send_request.serialize(body, content_type)
...
class ActionSendVoice(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def action_send_voice(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def action_send_voice(
        ...
        return self._action_send_voice_oapg(
            body=body,

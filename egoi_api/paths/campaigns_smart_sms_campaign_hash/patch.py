...
# body param
SchemaForRequestBodyApplicationJson = SmartSmsCampaignPatchRequest


request_body_smart_sms_campaign_patch_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = HashcodeCampaign
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_smart_sms_campaign_oapg(
        self,
    ...
    def _patch_smart_sms_campaign_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_smart_sms_campaign_patch_request.serialize(body, content_type)
...
class PatchSmartSmsCampaign(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_smart_sms_campaign(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def patch_smart_sms_campaign(
        ...
        return self._patch_smart_sms_campaign_oapg(
            body=body,

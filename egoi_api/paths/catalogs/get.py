        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Catalog']:
                        return Catalog
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Catalog'], typing.List['Catalog']],
                ...
                def __getitem__(self, i: int) -> 'Catalog':
...
class GetAllCatalogs(BaseApi):
    ...
    def get_all_catalogs(
        ...
        return self._get_all_catalogs_oapg(

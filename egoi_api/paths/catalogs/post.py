...
# body param
SchemaForRequestBodyApplicationJson = CatalogPostRequest


request_body_catalog_post_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Catalog
...
class BaseApi(api_client.Api):
    ...
    def _create_catalog_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_catalog_post_request.serialize(body, content_type)
...
class CreateCatalog(BaseApi):
    ...
    def create_catalog(
        ...
        return self._create_catalog_oapg(
            body=body,

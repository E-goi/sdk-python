...
# body param
SchemaForRequestBodyApplicationJson = EmailCampaignCreate


request_body_email_campaign_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_email_campaign_oapg(
        self,
    ...
    def _create_email_campaign_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_email_campaign_create.serialize(body, content_type)
...
class CreateEmailCampaign(BaseApi):
    ...
    def create_email_campaign(
        ...
        return self._create_email_campaign_oapg(
            body=body,

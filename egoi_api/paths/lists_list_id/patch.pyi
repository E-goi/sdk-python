...
# body param
SchemaForRequestBodyApplicationJson = PatchRequestList


request_body_patch_request_list = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ModelList
...
class BaseApi(api_client.Api):
    ...
    def _update_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_request_list.serialize(body, content_type)

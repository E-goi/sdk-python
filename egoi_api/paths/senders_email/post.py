...
# body param
SchemaForRequestBodyApplicationJson = EmailSenderPost


request_body_email_sender_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = EmailSender
...
class BaseApi(api_client.Api):
    ...
    def _create_email_sender_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_email_sender_post.serialize(body, content_type)
...
class CreateEmailSender(BaseApi):
    ...
    def create_email_sender(
        ...
        return self._create_email_sender_oapg(
            body=body,

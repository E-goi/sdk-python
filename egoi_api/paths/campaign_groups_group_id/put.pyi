...
SchemaFor200ResponseBodyApplicationJson = CampaignGroup
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_campaign_group_oapg(
        self,
...
class UpdateCampaignGroup(BaseApi):
    ...
    def update_campaign_group(
        ...
        return self._update_campaign_group_oapg(
            body=body,

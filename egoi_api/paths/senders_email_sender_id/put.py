...
# Path params
SenderIdSchema = QueryId
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'sender_id': typing.Union[SenderIdSchema, ],
    }
)
...
request_path_sender_id = api_client.PathParameter(
    name="sender_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SenderIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = EmailSenderPutRequest


request_body_email_sender_put_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EmailSender
...
class BaseApi(api_client.Api):
    ...
    def _put_email_sender_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_email_sender_put_request.serialize(body, content_type)
...
class PutEmailSender(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def put_email_sender(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def put_email_sender(
        ...
        return self._put_email_sender_oapg(
            body=body,

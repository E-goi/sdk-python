...
# body param
SchemaForRequestBodyApplicationJson = CampaignSmsSendRequest


request_body_campaign_sms_send_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _action_send_smart_sms_oapg(
        self,
    ...
    def _action_send_smart_sms_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_sms_send_request.serialize(body, content_type)
...
class ActionSendSmartSms(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def action_send_smart_sms(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def action_send_smart_sms(
        ...
        return self._action_send_smart_sms_oapg(
            body=body,

...
# Query params
DevicesSchema = schemas.BoolSchema
OperatingSystemsSchema = schemas.BoolSchema
BrowsersSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'devices': typing.Union[DevicesSchema, bool, ],
        'operating_systems': typing.Union[OperatingSystemsSchema, bool, ],
        'browsers': typing.Union[BrowsersSchema, bool, ],
...
request_query_devices = api_client.QueryParameter(
    name="devices",
    style=api_client.ParameterStyle.FORM,
    schema=DevicesSchema,
    explode=True,
)
request_query_operating_systems = api_client.QueryParameter(
    name="operating_systems",
    style=api_client.ParameterStyle.FORM,
    schema=OperatingSystemsSchema,
    explode=True,
)
request_query_browsers = api_client.QueryParameter(
    name="browsers",
    style=api_client.ParameterStyle.FORM,
    schema=BrowsersSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = WebPushReport
...
class BaseApi(api_client.Api):
    ...
    def _get_web_push_report_oapg(
        ...
        for parameter in (
            ...
            request_query_operating_systems,
            request_query_browsers,
            request_query_url,
        ):
...
class GetWebPushReport(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_web_push_report(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_web_push_report(
        ...
        return self._get_web_push_report_oapg(

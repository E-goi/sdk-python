...
# body param
SchemaForRequestBodyApplicationJson = GenerateEmailClicksByContactReport


request_body_generate_email_clicks_by_contact_report = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _generate_email_clicks_by_contact_report_oapg(
        self,
    ...
    def _generate_email_clicks_by_contact_report_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_generate_email_clicks_by_contact_report.serialize(body, content_type)
...
class GenerateEmailClicksByContactReport(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def generate_email_clicks_by_contact_report(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def generate_email_clicks_by_contact_report(
        ...
        return self._generate_email_clicks_by_contact_report_oapg(
            body=body,

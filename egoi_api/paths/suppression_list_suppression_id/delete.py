...
# Path params
SuppressionIdSchema = QueryId
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'suppression_id': typing.Union[SuppressionIdSchema, ],
    }
)
...
request_path_suppression_id = api_client.PathParameter(
    name="suppression_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SuppressionIdSchema,
    required=True,
)
_auth = [
    'Apikey',
...
SchemaFor409ResponseBodyApplicationJson = DeleteSuppressionListConflictsErrors
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_suppression_list_oapg(
        self,
...
class DeleteSuppressionList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_suppression_list(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_suppression_list(
        ...
        return self._delete_suppression_list_oapg(

...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["domain", "list_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["domain", "list_id", ], str]):
...
SchemaFor200ResponseBodyApplicationJson = TeResponse
...
SchemaFor409ResponseBodyApplicationJson = EnableTeConflict

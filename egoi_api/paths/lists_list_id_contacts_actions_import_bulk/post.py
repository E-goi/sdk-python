...
# body param
SchemaForRequestBodyApplicationJson = ImportBulkFileRequest


request_body_import_bulk_file_request = api_client.RequestBody(
    content={
...
SchemaFor413ResponseBodyApplicationJson = RequestEntityTooLarge
...
class BaseApi(api_client.Api):
    ...
    def _action_import_bulk_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_import_bulk_file_request.serialize(body, content_type)
...
class ActionImportBulk(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def action_import_bulk(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def action_import_bulk(
        ...
        return self._action_import_bulk_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = ContactExportRequest


request_body_contact_export_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _action_export_contacts_oapg(
        self,
    ...
    def _action_export_contacts_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_contact_export_request.serialize(body, content_type)
...
class ActionExportContacts(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def action_export_contacts(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def action_export_contacts(
        ...
        return self._action_export_contacts_oapg(
            body=body,

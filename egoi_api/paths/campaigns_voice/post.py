...
# body param
SchemaForRequestBodyApplicationJson = VoiceCampaign


request_body_voice_campaign = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_voice_campaign_oapg(
        self,
    ...
    def _create_voice_campaign_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_voice_campaign.serialize(body, content_type)
...
class CreateVoiceCampaign(BaseApi):
    ...
    def create_voice_campaign(
        ...
        return self._create_voice_campaign_oapg(
            body=body,

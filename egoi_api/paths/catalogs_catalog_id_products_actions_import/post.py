...
# body param
SchemaForRequestBodyApplicationJson = ProductBulkRequest


request_body_product_bulk_request = api_client.RequestBody(
    content={
...
SchemaFor413ResponseBodyApplicationJson = PayloadTooLarge
...
class BaseApi(api_client.Api):
    ...
    def _import_products_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_product_bulk_request.serialize(body, content_type)
...
class ImportProducts(BaseApi):
    ...
    def import_products(
        ...
        return self._import_products_oapg(
            body=body,

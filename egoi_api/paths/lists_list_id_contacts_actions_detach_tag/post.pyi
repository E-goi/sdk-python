...
# body param
SchemaForRequestBodyApplicationJson = DetachTagRequest


request_body_detach_tag_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _action_detach_tag_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_detach_tag_request.serialize(body, content_type)
...
class ActionDetachTag(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def action_detach_tag(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def action_detach_tag(
        ...
        return self._action_detach_tag_oapg(
            body=body,

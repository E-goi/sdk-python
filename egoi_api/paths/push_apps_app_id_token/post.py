...
# body param
SchemaForRequestBodyApplicationJson = PushToken


request_body_push_token = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _register_push_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_push_token.serialize(body, content_type)
...
class RegisterPushToken(BaseApi):
    ...
    def register_push_token(
        ...
        return self._register_push_token_oapg(
            body=body,

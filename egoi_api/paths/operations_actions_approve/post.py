...
# body param
SchemaForRequestBodyApplicationJson = OperationActionRequest


request_body_operation_action_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OperationActionResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _action_approve_operation_oapg(
        self,
    ...
    def _action_approve_operation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_operation_action_request.serialize(body, content_type)
...
class ActionApproveOperation(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def action_approve_operation(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def action_approve_operation(
        ...
        return self._action_approve_operation_oapg(
            body=body,

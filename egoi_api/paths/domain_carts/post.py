...
# body param
SchemaForRequestBodyApplicationJson = Cart


request_body_cart = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_cart_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cart.serialize(body, content_type)

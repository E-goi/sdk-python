...
# body param
SchemaForRequestBodyApplicationJson = ContactBaseExtraPost


request_body_contact_base_extra_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CreateContactResponse
...
SchemaFor409ResponseBodyApplicationJson = PostContactsConflict
...
class BaseApi(api_client.Api):
    ...
    def _create_contact_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_contact_base_extra_post.serialize(body, content_type)

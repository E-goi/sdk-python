...
# Query params
NetworksSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'networks': typing.Union[NetworksSchema, bool, ],
    },
    total=False
)
...
request_query_networks = api_client.QueryParameter(
    name="networks",
...
SchemaFor200ResponseBodyApplicationJson = PhoneReport
...
class GetVoiceReport(BaseApi):
    ...
    def get_voice_report(
        ...
        return self._get_voice_report_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = WebPushSite


request_body_web_push_site = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = WebPushSite
...
SchemaFor409ResponseBodyApplicationJson = PostWebpushSiteConflict
...
class BaseApi(api_client.Api):
    ...
    def _create_webpush_site_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_web_push_site.serialize(body, content_type)
...
class CreateWebpushSite(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_webpush_site(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_webpush_site(
        ...
        return self._create_webpush_site_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = GenerateSmsBouncesReport


request_body_generate_sms_bounces_report = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _generate_email_sms_report_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_generate_sms_bounces_report.serialize(body, content_type)

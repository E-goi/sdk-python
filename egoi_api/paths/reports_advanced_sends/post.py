...
# body param
SchemaForRequestBodyApplicationJson = GenerateSendsReport


request_body_generate_sends_report = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _generate_sends_report_oapg(
        self,
    ...
    def _generate_sends_report_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_generate_sends_report.serialize(body, content_type)
...
class GenerateSendsReport(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def generate_sends_report(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def generate_sends_report(
        ...
        return self._generate_sends_report_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = SmsCampaign


request_body_sms_campaign = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_sms_campaign_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sms_campaign.serialize(body, content_type)
...
class CreateSmsCampaign(BaseApi):
    ...
    def create_sms_campaign(
        ...
        return self._create_sms_campaign_oapg(
            body=body,

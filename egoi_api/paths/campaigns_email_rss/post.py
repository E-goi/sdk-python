...
# body param
SchemaForRequestBodyApplicationJson = EmailRssCampaignCreate


request_body_email_rss_campaign_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_email_rss_campaign_oapg(
        self,
    ...
    def _create_email_rss_campaign_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_email_rss_campaign_create.serialize(body, content_type)
...
class CreateEmailRssCampaign(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_email_rss_campaign(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_email_rss_campaign(
        ...
        return self._create_email_rss_campaign_oapg(
            body=body,

...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AppStructure']:
            return AppStructure

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['AppStructure'], typing.List['AppStructure']],
    ...
    def __getitem__(self, i: int) -> 'AppStructure':
...
class GetPushApps(BaseApi):
    ...
    def get_push_apps(
        ...
        return self._get_push_apps_oapg(

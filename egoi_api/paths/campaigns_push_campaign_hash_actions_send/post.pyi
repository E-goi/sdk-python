...
# body param
SchemaForRequestBodyApplicationJson = CampaignPushSendRequest


request_body_campaign_push_send_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _action_send_push_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_push_send_request.serialize(body, content_type)
...
class ActionSendPush(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def action_send_push(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def action_send_push(
        ...
        return self._action_send_push_oapg(
            body=body,

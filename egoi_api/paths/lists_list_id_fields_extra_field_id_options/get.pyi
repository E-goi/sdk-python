        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FieldOption']:
                        return FieldOption
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['FieldOption'], typing.List['FieldOption']],
                ...
                def __getitem__(self, i: int) -> 'FieldOption':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_field_options_oapg(
        self,
...
class GetAllFieldOptions(BaseApi):
    ...
    def get_all_field_options(
        ...
        return self._get_all_field_options_oapg(

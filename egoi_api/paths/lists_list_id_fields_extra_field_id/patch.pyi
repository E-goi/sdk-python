...
# body param
SchemaForRequestBodyApplicationJson = PatchRequestField


request_body_patch_request_field = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Field
...
class BaseApi(api_client.Api):
    ...
    def _patch_extra_field_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_request_field.serialize(body, content_type)
...
class PatchExtraField(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_extra_field(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def patch_extra_field(
        ...
        return self._patch_extra_field_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = CampaignEmailSendRequest


request_body_campaign_email_send_request = api_client.RequestBody(
    content={
...
SchemaFor409ResponseBodyApplicationJson = DeleteCampaignsConflict
...
class BaseApi(api_client.Api):
    ...
    def _action_send_email_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_campaign_email_send_request.serialize(body, content_type)
...
class ActionSendEmail(BaseApi):
    ...
    def action_send_email(
        ...
        return self._action_send_email_oapg(
            body=body,

...
class BasicProduct(object):
    ...
    def __init__(self, product_identifier=None, catalog_id=None, name=None, description=None, sku=None, upc=None, ean=None, gtin=None, mpn=None, link=None, image_link=None, price=0, sale_price=0, brand=None, local_vars_configuration=None):  # noqa: E501

...
class WebhookActionSchema(object):
    ...
    allowable_values = [FORGET_SUBSCRIPTION, CHANGE_CONSENT, WEB_PUSH_BOUNCE, WEB_PUSH_CLICK, WEB_PUSH_DELIVERED, WEB_PUSH_OPEN, WEB_PUSH_SEND, WEB_PUSH_SUBSCRIPTION, WEB_PUSH_UNSUBSCRIPTION, EMAIL_SEND, EMAIL_OPEN, EMAIL_CLICK, EMAIL_SOFT_BOUNCE, EMAIL_HARD_BOUNCE, SMS_SEND, VOICE_SEND, UNSUBSCRIBE, SUBSCRIPTION, RESUBSCRIPTION, FACEBOOK_LIKE, SOCIAL_SHARE, DOUBLE_OPTIN, EMAIL_SPAM_COMPLAINT, EMAIL_FIELD_DISABLE, CELLPHONE_FIELD_DISABLE, PHONE_FIELD_DISABLE, PUSH_SEND, PUSH_OPEN, PUSH_CLICK, PUSH_RECEIVED, PUSH_ERROR, PUSH_CANCELED]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """WebhookActionSchema - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebhookActionSchema):
            return False

...
class EcommerceApi(object):
    ...
    def create_cart(self, domain, cart, **kwargs):  # noqa: E501
        ...
        return self.create_cart_with_http_info(domain, cart, **kwargs)  # noqa: E501

    def create_cart_with_http_info(self, domain, cart, **kwargs):  # noqa: E501
        """Create cart  # noqa: E501

        Creates a new cart. If ***contact_id*** is specified, order will be atached to the contact, if the contact propreties are specified, we'll create the user, if its already in your list it will get the correct contact (**make sure you are sending atleast all configured list's unique fields**). This same logic is also applied to the **product_identifier**.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_cart_with_http_info(domain, cart, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['domain', 'cart']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `domain` when calling `create_cart`")  # noqa: E501
        # verify the required parameter 'cart' is set
        if self.api_client.client_side_validation and ('cart' not in local_var_params or  # noqa: E501
                                                        local_var_params['cart'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `cart` when calling `create_cart`")  # noqa: E501
        ...
        body_params = None
        if 'cart' in local_var_params:
            body_params = local_var_params['cart']
        # HTTP header `Accept`
    ...
    def create_order(self, domain, create_order, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_order(domain, create_order, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str domain: Domain (required)
        :param CreateOrder create_order: Parameters for the Orders (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.create_order_with_http_info(domain, create_order, **kwargs)  # noqa: E501

    def create_order_with_http_info(self, domain, create_order, **kwargs):  # noqa: E501
        """Create order  # noqa: E501

        Creates a new order. If **contact_id** is specified, order will be atached to the contact, if the contact propreties are specified, we'll create the user, if its already in your list it will get the correct contact (***make sure you are sending atleast all configured list's unique fields***). This same logic is also applied to the **product_identifier**.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_order_with_http_info(domain, create_order, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['domain', 'create_order']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('domain' not in local_var_params or  # noqa: E501
                                                        local_var_params['domain'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `domain` when calling `create_order`")  # noqa: E501
        # verify the required parameter 'create_order' is set
        if self.api_client.client_side_validation and ('create_order' not in local_var_params or  # noqa: E501
                                                        local_var_params['create_order'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `create_order` when calling `create_order`")  # noqa: E501
        ...
        body_params = None
        if 'create_order' in local_var_params:
            body_params = local_var_params['create_order']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def import_products(self, catalog_id, product_bulk_request, **kwargs):  # noqa: E501
        ...
        Imports a collection of products</br>      **DISCLAIMER:** stream limits applied. [view here](#section/Stream-Limits 'Stream Limits')  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

...
class EmailReportByDate(
            ...
            class date(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["date", "sends", "opens", "clicks", "hard_bounces", "soft_bounces", "complaints", "unsubscriptions", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date", "sends", "opens", "clicks", "hard_bounces", "soft_bounces", "complaints", "unsubscriptions", ], str]):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date", ], str]):
        return super().get_item_oapg(name)

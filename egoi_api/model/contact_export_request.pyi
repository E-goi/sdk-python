...
class ContactExportRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["format", "callback_url", "segments", "fields", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["format", "callback_url", "segments", "fields", ], str]):

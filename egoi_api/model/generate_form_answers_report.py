...
class GenerateFormAnswersReport(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def forms() -> typing.Type['AdvancedReportForms']:
                return AdvancedReportForms
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["forms"]) -> 'AdvancedReportForms': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "range", "forms", "callback_url", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["forms"]) -> 'AdvancedReportForms': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "range", "forms", "callback_url", ], str]):

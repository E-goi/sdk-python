...
class EmailClicksByContactListStatsFields(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["clicks", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["clicks", ], str]):

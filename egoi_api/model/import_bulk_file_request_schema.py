...
class ImportBulkFileRequestSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mode", "compare_field", "file", "force_empty", "notify", "callback_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mode", "compare_field", "file", "force_empty", "notify", "callback_url", ], str]):

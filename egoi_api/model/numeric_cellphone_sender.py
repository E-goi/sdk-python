...
class NumericCellphoneSender(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class cellphone(
                        ...
                        class MetaOapg:
                            regex=[{
                                'pattern': r'^(){0,1}(\d){1,3}-(\d){4,20}$',  # noqa: E501
                            }]
                    __annotations__ = {
                        "cellphone": cellphone,
                    }
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["cellphone", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cellphone", ], str]):
    ...
    cellphone: schemas.AnyTypeSchema

...
class WebPushStats(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["opens", "sends", "clicks", "bounces", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["opens", "sends", "clicks", "bounces", ], str]):

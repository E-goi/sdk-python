...
class CreateOrderResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["order_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["order_id", ], str]):

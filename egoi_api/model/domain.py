...
class Domain(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["domain", "list_id", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["domain", "list_id", "status", ], str]):

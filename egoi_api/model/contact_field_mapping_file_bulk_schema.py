...
class ContactFieldMappingFileBulkSchema(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def field_id() -> typing.Type['FieldId']:
                return FieldId
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["field_id"]) -> 'FieldId': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["field_id", "column_name", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["field_id"]) -> 'FieldId': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["field_id", "column_name", ], str]):

...
class ConnectedSitesGeneralProductFormDetail(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["internal_name", "form_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["internal_name", "form_id", ], str]):

...
class ContactSearchResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contact_id", "list_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contact_id", "list_id", ], str]):

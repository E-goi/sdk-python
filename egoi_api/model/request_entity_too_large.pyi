...
class RequestEntityTooLarge(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class title(
                ...
                def REQUEST_ENTITY_TOO_LARGE(cls):
                    return cls("Request Entity Too Large")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "title", "status", "detail", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "title", "status", "detail", ], str]):

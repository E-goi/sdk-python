...
class ProductBulkRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["products", "mode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["products", "mode", ], str]):

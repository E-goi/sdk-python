...
class PatchRequestList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["internal_name", "public_name", "group_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["internal_name", "public_name", "group_id", ], str]):

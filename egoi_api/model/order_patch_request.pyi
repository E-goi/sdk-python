...
class OrderPatchRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cart_total", "cart_id", "contact", "products", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cart_total", "cart_id", "contact", "products", ], str]):

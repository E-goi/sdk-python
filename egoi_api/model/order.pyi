...
class Order(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            cart_total = schemas.Float64Schema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["cart_total"]) -> MetaOapg.properties.cart_total: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["order_id", "cart_total", "cart_id", "contact", "products", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cart_total"]) -> typing.Union[MetaOapg.properties.cart_total, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["order_id", "cart_total", "cart_id", "contact", "products", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        cart_total: typing.Union[MetaOapg.properties.cart_total, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,

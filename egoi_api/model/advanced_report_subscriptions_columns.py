...
class AdvancedReportSubscriptionsColumns(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def list_stats_fields() -> typing.Type['SubscriptionsListStatsFields']:
                return SubscriptionsListStatsFields
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["list_stats_fields"]) -> 'SubscriptionsListStatsFields': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["list_stats_fields"]) -> 'SubscriptionsListStatsFields': ...

...
class AutomationPost(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "list_id", "status", "allow_multiple_contacts", "contact_limit", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "list_id", "status", "allow_multiple_contacts", "contact_limit", ], str]):

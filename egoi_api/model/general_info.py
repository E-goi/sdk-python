...
class GeneralInfo(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class general_info(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "website", "cellphone", "client_id", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "website", "cellphone", "client_id", ], str]):
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["general_info"]) -> MetaOapg.properties.general_info: ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["general_info", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["general_info"]) -> typing.Union[MetaOapg.properties.general_info, schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["general_info", ], str]):
                return super().get_item_oapg(name)
            ...
            def __new__(
                cls,
                *args: typing.Union[dict, frozendict.frozendict, ],
                general_info: typing.Union[MetaOapg.properties.general_info, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                _configuration: typing.Optional[schemas.Configuration] = None,
                **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
            ) -> 'all_of_0':
                return super().__new__(

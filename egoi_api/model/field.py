...
class Field(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "format", "field_id", "unique", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "format", "field_id", "unique", ], str]):

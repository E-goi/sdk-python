...
class HeaderFooterTemplate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["template_id", "internal_name", "custom", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["template_id", "internal_name", "custom", ], str]):

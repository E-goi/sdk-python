...
class SingleCartObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["revenue", "store_url", "items", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["revenue", "store_url", "items", ], str]):

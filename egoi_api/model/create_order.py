...
class CreateOrder(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["order_total"]) -> MetaOapg.properties.order_total: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["order_total"]) -> typing.Union[MetaOapg.properties.order_total, schemas.Unset]: ...

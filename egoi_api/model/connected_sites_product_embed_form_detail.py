...
class ConnectedSitesProductEmbedFormDetail(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["form_hash"]) -> MetaOapg.properties.form_hash: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["internal_name", "form_id", "form_hash", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["form_hash"]) -> typing.Union[MetaOapg.properties.form_hash, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["internal_name", "form_id", "form_hash", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        form_hash: typing.Union[MetaOapg.properties.form_hash, str, schemas.Unset] = schemas.unset,

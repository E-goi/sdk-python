        ...
        class all_of_2(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def segments() -> typing.Type['SmsSegmentsActionSend']:
                        return SmsSegmentsActionSend
                    __annotations__ = {
                        "segments": segments,
                    }
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["segments"]) -> 'SmsSegmentsActionSend': ...
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["segments"]) -> typing.Union['SmsSegmentsActionSend', schemas.Unset]: ...
            ...
            def __new__(
                cls,
                *args: typing.Union[dict, frozendict.frozendict, ],
                segments: typing.Union['SmsSegmentsActionSend', schemas.Unset] = schemas.unset,
                _configuration: typing.Optional[schemas.Configuration] = None,
                **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
            ) -> 'all_of_2':
                return super().__new__(

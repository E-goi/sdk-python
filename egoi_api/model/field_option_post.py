...
class FieldOptionPost(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["en", "pt", "br", "es", "de", "hu", "fr", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["en", "pt", "br", "es", "de", "hu", "fr", ], str]):

...
class ImportOrdersBulkBulkRequestItems(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "category", "price", "quantity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "category", "price", "quantity", ], str]):

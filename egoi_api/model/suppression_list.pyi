...
class SuppressionList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "value", "type", "method", "campaign_hash", "created", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "value", "type", "method", "campaign_hash", "created", ], str]):

...
class PatchRequestField(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "unique", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "unique", ], str]):

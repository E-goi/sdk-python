...
class Catalog(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["catalog_id", "title", "language", "currency", "created", "updated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["catalog_id", "title", "language", "currency", "created", "updated", ], str]):

...
class UnprocessableEntity(
        ...
        class properties:
            ...
            class title(
                ...
                def UNPROCESSABLE_ENTITY(cls):
                    return cls("Unprocessable Entity")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errors", "type", "title", "status", "detail", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errors", "type", "title", "status", "detail", ], str]):

...
class SingleOrderObject(
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ImportOrdersBulkBulkRequestItems']:
                        return ImportOrdersBulkBulkRequestItems
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ImportOrdersBulkBulkRequestItems'], typing.List['ImportOrdersBulkBulkRequestItems']],
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["store_url"]) -> MetaOapg.properties.store_url: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["order_id", "revenue", "store_url", "items", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["store_url"]) -> MetaOapg.properties.store_url: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["order_id", "revenue", "store_url", "items", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        date: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],

...
class ImportBulkRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class mode(
                ...
                def UPDATE(cls):
                    return cls("update")
            compare_field = schemas.StrSchema
            ...
            class contacts(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ContactBulk']:
                        return ContactBulk
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ContactBulk'], typing.List['ContactBulk']],
                ...
                def __getitem__(self, i: int) -> 'ContactBulk':
                    return super().__getitem__(i)
            force_empty = schemas.BoolSchema
    ...
    compare_field: MetaOapg.properties.compare_field
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["compare_field"]) -> MetaOapg.properties.compare_field: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["contacts"]) -> MetaOapg.properties.contacts: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["force_empty"]) -> MetaOapg.properties.force_empty: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mode", "compare_field", "contacts", "force_empty", "notify", "callback_url", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["compare_field"]) -> MetaOapg.properties.compare_field: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["contacts"]) -> MetaOapg.properties.contacts: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["force_empty"]) -> typing.Union[MetaOapg.properties.force_empty, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mode", "compare_field", "contacts", "force_empty", "notify", "callback_url", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        compare_field: typing.Union[MetaOapg.properties.compare_field, str, ],
        contacts: typing.Union[MetaOapg.properties.contacts, list, tuple, ],
        force_empty: typing.Union[MetaOapg.properties.force_empty, bool, schemas.Unset] = schemas.unset,
        notify: typing.Union[MetaOapg.properties.notify, list, tuple, schemas.Unset] = schemas.unset,

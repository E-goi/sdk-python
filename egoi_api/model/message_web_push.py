...
class MessageWebPush(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "message", "link", "icon", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "message", "link", "icon", ], str]):

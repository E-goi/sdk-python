# egoi_api.model.contact_base_with_status_no_removed_fields_schema.ContactBaseWithStatusNoRemovedFieldsSchema
...
**status** | str,  | str,  | Status of the contact | [optional] must be one of ["active", "inactive", "unconfirmed", ] if omitted the server will use the default value of "active"

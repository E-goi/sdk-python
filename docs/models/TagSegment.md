# egoi_api.model.tag_segment.TagSegment
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Tag segment schema | 
...
------------ | ------------- | ------------- | ------------- | -------------
**type** | str,  | str,  | Type of segment | [optional] must be one of ["tag", ] 

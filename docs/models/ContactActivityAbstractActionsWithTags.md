# egoi_api.model.contact_activity_abstract_actions_with_tags.ContactActivityAbstractActionsWithTags
...
**action_name** | str,  | str,  | Action name | [optional] must be one of ["attach_tag", "detach_tag", ] 

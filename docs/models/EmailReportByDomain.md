# egoi_api.model.email_report_by_domain.EmailReportByDomain
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Email stats grouped by Domain | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**[domain](#domain)** | list, tuple,  | tuple,  | Email stats grouped by Domain | [optional] 
